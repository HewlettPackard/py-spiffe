...
class X509SVIDResponse(google.protobuf.message.Message):
    ...
    @property
    def svids(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___X509SVID]:
        ...
        """
    @property
    def crl(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.bytes]:
        """Optional. ASN.1 DER encoded certificate revocation lists."""
    @property
    def federated_bundles(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.bytes]:
    ...
    def __init__(
        ...
        *,
        ...
        federated_bundles: collections.abc.Mapping[builtins.str, builtins.bytes] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["crl", b"crl", "federated_bundles", b"federated_bundles", "svids", b"svids"]) -> None: ...
...
class X509SVID(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bundle", b"bundle", "spiffe_id", b"spiffe_id", "x509_svid", b"x509_svid", "x509_svid_key", b"x509_svid_key"]) -> None: ...
...
class X509BundlesResponse(google.protobuf.message.Message):
    ...
    def crl(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.bytes]:
        """Optional. ASN.1 DER encoded certificate revocation lists."""
    @property
    def bundles(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.bytes]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bundles", b"bundles", "crl", b"crl"]) -> None: ...
...
class JWTSVIDRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audience", b"audience", "spiffe_id", b"spiffe_id"]) -> None: ...
...
class JWTSVIDResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["svids", b"svids"]) -> None: ...
...
class JWTSVID(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["spiffe_id", b"spiffe_id", "svid", b"svid"]) -> None: ...
...
class ValidateJWTSVIDRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audience", b"audience", "svid", b"svid"]) -> None: ...
...
class ValidateJWTSVIDResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["claims", b"claims", "spiffe_id", b"spiffe_id"]) -> None: ...
